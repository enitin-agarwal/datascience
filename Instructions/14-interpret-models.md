...
사용자의 건강, 안전, 재정 상황 및 일상 생활의 기타 측면에 영향을 주는 의사 결정 과정에서 기계 학습의 중요도가 갈수록 높아짐에 따라, 모델이 예측을 하는 방식을 이해할 수 있어야 하며 기계 학습 기반 의사 결정의 근거를 설명할 수 있어야 합니다.
...
1. Jupyter 홈 페이지에서 Notebook 리포지토리를 복제한 **/users/*your-user-name*/mslearn-dp100** 폴더로 이동하여 **Interpret Models** Notebook을 엽니다.
